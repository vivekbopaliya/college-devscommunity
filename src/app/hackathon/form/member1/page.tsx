...
export default function ProfileForm() {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    const data = {
      Member_1: teamMember1Name,
      M1_Email: teamLeaderEmail,
    ...
    try {
      ...
      route.push("/hackathon/form/member2");
    } catch (error) {
      toast({
  ...
  return (
    <main className="sm:pb-0 pb-10">
      <p className="text-sm font-light my-2 w-3/5 text-blue-500">
        ...
        <form className="space-y-16">
          <div className="my-3">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Team Member 1's Name</FormLabel>
                  <FormControl>
                    <Input
                  ...
                  <FormDescription>
                    This should be team member 1's name only.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="my-8  flex flex-col gap-3">
            <p className="text-sm font-light">Select team member 1's Course</p>
